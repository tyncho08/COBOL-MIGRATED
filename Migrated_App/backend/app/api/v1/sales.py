...
from app.models.transactions import SalesInvoice, CustomerPayment
from app.models.customers import Customer
from app.models.users import User
from app.schemas.sales import (
    CustomerCreate, CustomerUpdate, CustomerResponse,
    SalesInvoiceCreate, SalesInvoiceResponse,
    CustomerPaymentCreate, PaymentAllocationCreate,
...
async def create_invoice(
    ...
    if hasattr(current_user, 'module_access') and current_user.module_access.get("SL", 0) < 2:
        raise HTTPException(
